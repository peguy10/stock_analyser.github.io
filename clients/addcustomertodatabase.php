...
if(isset($_POST["submit"])) {
    ...
    $conn = mysqli_connect($server, $user, $pass,$bd);
        ...
        $sql = "INSERT INTO customer(name_customer,email_customer,phone_customer,country_customer,city_customer,adress_customer,description_customer,avatar_customer) 
        VALUES ('$name_customer','$email_customer','$phone_customer','$country_customer','$city_customer','$adress_customer','$description_customer','$avatar_customer')";
