...
<li><a href="../clients/customerlist.php">Customer List</a></li>
                                ...
                                <li><a href="../founisseurs/supplierlist.php">Supplier List</a></li>
                                <li><a href="../fournisseur/addsupplier.php">Add Supplier </a></li>
...
<input type="text" 
value="<?php echo $_GET['name_custumer']; ?>"
id="name_custumer"
name="name_custumer">
</div>
</div>
...
<label>Email</label>
<input type="text" 
value="<?php echo $_GET['email_customer']; ?>"
id="email_customer"
name="email_customer">
</div>
</div>
...
<label>Phone</label>
<input type="text" 
value="<?php echo $_GET['phone_customer']; ?>"
id="phone_customer"
name="phone_customer">
</div>
</div>
...
<select class="select"
value="<?php echo $_GET['country_customer']; ?>"
id="country_customer"
...
<label>City</label>
<select class="select"
value="<?php echo $_GET['city_customer']; ?>"
id="city_customer"
name="city_customer">>
...
<label>Address</label>
<input type="text" 
value="<?php echo $_GET['adress_customer']; ?>"
id="adress_customer"
name="adress_customer">
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
...
value="<?php echo $_GET['description_customer']; ?>"
id="drescription_customer"
name="description_customer"></textarea>
</div>
</div>
                                ...
                                <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="productviewscontent">
                                                    ...
                                                    <input type="hidden" value="<?php echo $_GET['avatar_customer']; ?>"
                                                    id="old_customer_image"
                                                    name="old_customer_image">
                                                    </div>
                                                </div>
                                            </div>
