<div class="row">
    ...
    <div class="col-lg-6 col-sm-6 col-12">
        <div class="dash-widget dash1">
            ...
            <div class="dash-widgetcontent">
                <h5><span class="counters" data-count="<?php echo $total_sales_due; ?>"><?php echo number_format($total_sales_due,'0',',',' ') ; ?></span> FCFA</h5>
    ...
    <!-- <div class="col-lg-3 col-sm-6 col-12">
        <div class="dash-widget dash2">
            ...
            <div class="dash-widgetcontent">
                <h5><span class="counters" data-count="385656.50">385,656.50</span> FCFA</h5>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
        <div class="dash-widget dash3">
            ...
            <div class="dash-widgetcontent">
                <h5><span class="counters" data-count="40000.00">400.00</span> FCFA</h5>
                <h6>Total Sale Amount</h6>
            </div>
        </div>
    </div> -->
