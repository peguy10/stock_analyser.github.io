                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                    value="<?php echo $_GET['product_name']; ?>"
                                    id="product_name"
                                    name="product_name"
                                    required="required">
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>SKU</label>
                                    <input type="text" value="<?php echo $_GET['sku']; ?>"
                                    id="sku"
                                    name="sku"
                                    required="required">
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                    value="<?php echo $_GET['minimum_quantity']; ?>"
                                            id="minimum_quantity"
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="<?php echo $_GET['quantity']; ?>"
                                    id="quantity"
                                    name="quantity"
                                    required="required">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        class="form-control"
                                            ...
                                            id="descriptions"
                                            name="descriptions"
                                            required="required"><?php echo $_GET['descriptions']; ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="number" value="<?php echo $_GET['price']; ?>"
                                    id="price"
                                    name="price"
                                    required="required">
                                </div>
                                    ...
                                    <ul class="row">
                                        ...
                                        <div class="productviews">
                                                ...
                                                <div class="productviewscontent">
                                                    ...
                                                    <input type="hidden" value="<?php echo $_GET['product_image']; ?>"
