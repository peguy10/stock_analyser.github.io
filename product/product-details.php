                            ...
                            <div class="bar-code-view">
                                ...
                                <div class="productdetails">
                                    <ul class="product-bar">
                                        <li>
                                            <h4>Product</h4>
                                            <h6><?php echo $_GET['product_name']; ?> </h6>
                                        </li>
                                        <li>
                                            <h4>Category</h4>
                                            <h6><?php echo $_GET['category']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Sub Category</h4>
                                            <h6><?php echo $_GET['sub_category']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Brand</h4>
                                            <h6><?php echo $_GET['brand']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Unit</h4>
                                            <h6><?php echo $_GET['unit']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>SKU</h4>
                                            <h6><?php echo $_GET['sku']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Minimum Qty</h4>
                                            <h6><?php echo $_GET['minimum_quantity']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Quantity</h4>
                                            <h6><?php echo $_GET['quantity']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Tax(%)</h4>
                                            <h6><?php echo $_GET['tax']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Discount Type(%)</h4>
                                            <h6><?php echo $_GET['discount_type']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Price</h4>
                                            <h6><?php echo $_GET['price']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Status</h4>
                                            <h6><?php echo $_GET['statuss']; ?></h6>
                                        </li>
                                        <li>
                                            <h4>Description</h4>
                                            <h6><?php echo $_GET['descriptions']; ?></h6>
                                        </li>
                                    </ul>
                                </div>
                            </div>
