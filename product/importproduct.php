...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/dataTabls.bootstrap4.min.css">

    <link rel="stylesheet" href="../assets/plugins/fontawesme/css/fontawesome.min.css">
        ...
        <div cass="header">
            ...
            <ul class="nav user-menu">
                        ...
                        <a href="javascript:void(0);" class="responsive-search">
                            ...
                            <a>
                                <form action="#">
                                    ...
                                    </div <a class="btn" id="searchdiv"><img src="../assets/img/icons/search.svg"
                                        alt="img">
                            </a>
                            </form>
                    </div>
                ...
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-bs-toggl="dropdown" href="javascript:void(0);"
                        role="button">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="../assets/im/flags/de.png" alt="" height="16"> German
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropown-menu notifications">
                            ...
                            <ul class="notification-list">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="../assets/img/profiles/avatar-03.jg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="../assets/img/profiles/avatar-06jpg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                ...
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media d-flex">
                                            <span class="avatar flex-shrink-0">
                                                <img alt="" src="../assets/img/profiles/avatar-17.jg">
                                            </span>
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span class="noti-title">Rolland Webber</span>
                                                    completed task <span class="noti-title">Patien and Doctor video
                                                        conferencing</span></p>
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link serset" data-bs-toggle="dropdown">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:oid(0);"><img src="../assets/img/icons/sales1.svg" alt="img"><span>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="importpurchase.htl">Import Purchase</a></li>
                            </ul>
                        </li>
                       <!-- <li class="submenu">
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="addqotation.html">Add Quotation</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="../clients/suplierlist.php">Supplier List</a></li>
                                <li><a href="../clients/addsupplier.php">Add Supplier </a></li>
