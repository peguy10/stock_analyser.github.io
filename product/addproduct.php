                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>SKU</label>
                                        <input type="text" id="sku" name="sku" required="required">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Minimum Qty</label>
                                        <input type="number" id="minimum_quantity" name="minimum_quantity" required="required">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" type="text" id="descriptions" name="descriptions" required="required">
                                </textarea>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
