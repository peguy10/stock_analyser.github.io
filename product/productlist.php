            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <!-- add product page -->
                        ...
                        <a href="addproduct.php" class="btn btn-added"><img src="../assets/img/icons/plus.svg"
                ...
                <div class="card">
                    ...
                    if($report == TRUE){
                        ...
                        while($row=mysqli_fetch_array($report))
                        {
                            ...
                            echo$row['created_by'];
                            echo "</td><td>";
                            echo "<a class='me-3' href='product-details.php?
                            id=".$row['id']."&
                            ...
                            <a class='confirm-text' href='delete_product.php?
                            id=".$row['id']."&
                            sub_category=".$row['sub_category']."&
                            minimum_quantity=".$row['minimum_quantity']."&
                            descriptions=".$row['descriptions']."&
