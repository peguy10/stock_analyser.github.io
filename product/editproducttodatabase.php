...
$sql = "UPDATE product_list SET product_image = '$product_image', product_name = '$product_name',sku = '$sku',id_categorie = '$category',id_fournisseur = '$id_f',price = '$price',quantity = '$quantity',descriptions = '$descriptions',tax = '$tax',status = '$status'WHERE sku='$sku'";
