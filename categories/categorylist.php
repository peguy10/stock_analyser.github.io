            ...
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        ...
                        <!-- add category page -->
                        <a href="addcategory.php" class="btn btn-added"><img src="../assets/img/icons/plus.svg" alt="img" class="me-1">Add New Category</a>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <td class='productimgname'>
                                ...
                                <a href='javascript:void(0);'>";
                                            ...
                                            echo "
                            <td>";
                                            echo $row['code_category'];
                                            echo "</td>
                            <td>";
                                            echo $row['description_category'];
                                            echo "</td>
                            <td>";
                                            echo $row['created_by'];
                                            echo "</td>
