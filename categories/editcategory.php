                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="../fournisseurs/supplierlist.html">Supplier List</a></li>
                                <li><a href="../fournisseurs/addsupplier.html">Add Supplier </a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                    value="<?php echo $_GET['name_category']; ?>"
                                    id="name_category"
                                    name="name_category">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $_GET['code_category']; ?>"
                                    id="code_category"
                                    name="code_category">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" value="<?php echo $_GET['description_category']; ?>"
                                    id="description_category"
                                    name="description_category">Computers Description</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <ul class="row">
                                        <li class="ps-0">
                                                ...
                                                <div class="productviewscontent">
                                                    ...
                                                    <input type="hidden" value="<?php echo $_GET['image_category']; ?>"
