                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                    value="<?php echo $_GET['name_supplier']; ?>"
                                    id="name_supplier"
                                    name="name_supplier">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="text" 
                                    value="<?php echo $_GET['email_supplier']; ?>"
                                    id="email_supplier"
                                    name="email_supplier">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" 
                                    value="<?php echo $_GET['phone_supplier']; ?>"
                                    id="phone_supplier"
                                    name="phone_supplier">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select"
                                    value="<?php echo $_GET['country_supplier']; ?>"
                                    id="country_supplier"
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>City</label>
                                    <select class="select"
                                    value="<?php echo $_GET['city_supplier']; ?>"
                                    id="city_supplier"
                                    name="city_supplier">
                            ...
                            <div class="col-lg-9 col-12">
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text"  value="<?php echo $_GET['address_supplier']; ?>"
                                    id="address_supplier"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    type="text"
                                            ...
                                            ><?php echo $_GET['description_supplier']; ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <input type="hidden" value="<?php echo $_GET['avatar_supplier']; ?>"
                                                    id="old_supplier_image"
                                                    name="old_supplier_image">
                                        </div>
                                    </div>
                                </div>
                            </div>
