                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            <input type="hidden" name="ref" value="<?php echo $fact ?>">
                            <input type="hidden" name="id_c" value="<?php echo $customer['id_c']; ?>">
                                            ...
                                            <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                                ...
                                                <td>
                                                    <label class="checkboxs">
                                                        <input type="checkbox" name="facts[]" value="<?php echo $client['id']; ?>" checked>
                                                ...
                                                <td style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                                    ...
                                                    <input type="hidden" value="<?php echo $client['id']; ?>" name="id_p">
                                                </td>
                                                <td style="padding: 10px;vertical-align: top; ">
                                                    <?php echo $client['quantity_sale']; ?>
                                                    <input type="hidden" value="<?php echo $client['quantity_sale']; ?>" name="qty<?php echo $client['id']; ?>">

                                                </td>
                                                <td style="padding: 10px;vertical-align: top; ">
                                                    <?php echo number_format($client['sale_price'], '0', ',', ' '); ?> FCFA
                                                    <input type="hidden" value="<?php echo $client['sale_price']; ?>" name="price<?php echo $client['id']; ?>">
                                                </td>
                                                <td style="padding: 10px;vertical-align: top; ">
                                                    <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="btn btn-submit me-2" name="add_fact">submit</button>
